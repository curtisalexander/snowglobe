...
- [Implementation plan](../PLAN.md) — current scope, milestones, progress, and open deployment inputs.
...
- [Synthetic proof threat model](threat-model.md) — identities, trust boundaries, data flows, and required boundary evidence.
