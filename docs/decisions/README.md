...
| [0009](0009-constrained-snowflake-mvp-budgets.md) | Superseded in part by [0017](0017-minimal-model-context-boundary.md) and [0018](0018-minimal-boundary-cleanup.md) | Fixed connection, execution, concurrency, and result budgets for the constrained Snowflake MVP |
| [0010](0010-minimum-snowflake-select-policy.md) | Superseded by [0019](0019-relation-centric-sql-authorization.md) | Recursive Snowflake SELECT AST allowlist with approved views, no functions, and a server-owned overflow cap |
